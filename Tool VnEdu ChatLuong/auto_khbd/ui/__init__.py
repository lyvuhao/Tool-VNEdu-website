"""Giao diện Tkinter của tool KHDH.

Mục lục module:

    advanced_window   Cửa sổ Nâng cao.
    backup_restore/   BackupRestoreDialog — hộp thoại sao lưu/khôi phục, ghép từ các mixin.
    ...
    workers/          Các thread worker chạy nền (CDP) gửi sự kiện về giao diện qua queue.
"""
